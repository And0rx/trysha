...
var botConfigs = {
    token: "NTU2NTQ5MjU4NDA1MzQ3Mzgx.XKjg-w.al3C0XP3JlR_pJc2JwvwX7RRlPo",
    prefix: "!",
    gameStatus: "!help and !dhelp",
    statusType: "WATCHING",
    commands: [{"id":1,"command":"help","message":"","embed":true,"embedFields":[{"title":"m!purge","text":"purge messages"},{"title":"m!play (link,search)","text":"listen music"},{"title":"m!ticket (title)","text":"create ticket"},{"title":"m!skip","text":"skip song"},{"title":"m!kick","text":"kick member"}]},{"id":2,"command":"dhelp","message":"","embed":true,"embedFields":[{"title":"dc help all ","text":"https://discord.gg/a2QFqF4"}]}],
    ...
    welcomemessage: {"channelid":"556589966243659831","text":"Joined the server"},
    weather: {"degree":"C"},
    ticketsystem: {"ticketCategoryID":"557988691285639178","createTicketChannelID":"557986032813998091"}
};
